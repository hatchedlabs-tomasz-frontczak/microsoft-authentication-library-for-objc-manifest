Pod::Spec.new do |s|
  s.name         = "MSAL-manifest"
  s.version      = "2.0.0"
  s.summary      = "Microsoft Authentication Library (MSAL) for iOS"
  s.description  = <<-DESC
                   The MSAL library for iOS gives your app the ability to begin using the Microsoft Cloud by supporting Microsoft Azure Active Directory and Microsoft Accounts in a converged experience using industry standard OAuth2 and OpenID Connect. The library also supports Microsoft Azure B2C for those using our hosted identity management service.
                   DESC
  s.homepage     = "https://github.com//hatchedlabs-tomasz-frontczak/microsoft-authentication-library-for-objc"
  s.license      = { 
    :type => "MIT", 
    :file => "LICENSE" 
  }
  ...
  s.source       = { 
    :git => "https://github.com//hatchedlabs-tomasz-frontczak/microsoft-authentication-library-for-objc-manifest.git",
    :tag => s.version.to_s,
    :submodules => true
  }
